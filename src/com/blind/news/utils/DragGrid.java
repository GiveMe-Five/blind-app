...
//	private int itemHeight, itemWidth;
	...
	private void startDrag(final Bitmap bm, final int x, final int y) {
		...
		Animation disappear= AnimationUtils.loadAnimation(getContext(), R.anim.news_out);
		disappear.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				iv_drag.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.news_del_done));
